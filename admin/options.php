...
if (isset($_POST['update_option'])) {
	...
	if (isset($_POST['wsppcp_exclude-tag']))	    $exclude_tag	    = $_POST['wsppcp_exclude-tag'];
...
<div class="wrap wsppcp-main-box">
	...
	<div class="wsppcp-hidden <?php if ($tab == null) {
									_e('wsppcp-active-tab');
								} ?>">
	...
	<form method="post" id="wsppcp_remove_content" class="wsppcp-hidden <?php if ($tab == "remove-content") {
																			_e('wsppcp-active-tab');
																		} ?>">
					...
					<?php foreach ($wsppcp_hook_value as $wsppcp_title => $wsppcp_hook) {  ?>
						<li>
							<div class="wsppcp-list">
								...
								<div><input name="wsppcp_single_checkbox[]" type="checkbox" id="wsppcp_<?php echo $wsppcp_hook; ?>" value="<?php echo $wsppcp_hook ?>" <?php if (!empty($wsppcp_wc_single_value)) {
																																											if (in_array($wsppcp_hook, $wsppcp_wc_single_value)) {
																																												echo "checked";
																																											}
																																										} ?>></div>
							</div>
	...
	<form method="post" id="wsppcp_label_setting" class="wsppcp-hidden <?php if ($tab == "label-setting") {
																			_e('wsppcp-active-tab');
																		} ?>">
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="description_tab_title" <?php if (isset($description_tab_title)) {
																		echo 'value="' . $description_tab_title . '"';
																	} ?>>
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="additional_tab_title" <?php if (isset($additional_info_tab_title)) {
																		echo 'value="' . $additional_info_tab_title . '"';
																	} ?>>
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="reviews_tab_title" <?php if (isset($reviews_tabbing_title)) {
																	echo 'value="' . $reviews_tabbing_title . '"';
																} ?>>
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="description_con_title" <?php if (isset($description_heading)) {
																		echo 'value="' . $description_heading . '"';
																	} ?>>
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="additional_con_title" <?php if (isset($additional_info_heading)) {
																		echo 'value="' . $additional_info_heading . '"';
																	} ?>>
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="cart_btn_text" <?php if (isset($add_to_cart_text)) {
																echo 'value="' . $add_to_cart_text . '"';
															} ?>>
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="stock_out_description" <?php if (isset($single_out_of_stock_text)) {
																		echo 'value="' . $single_out_of_stock_text . '"';
																	} ?>>
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="backorder_text" <?php if (isset($single_backorder_text)) {
																	echo 'value="' . $single_backorder_text . '"';
																} ?>>
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="sale_badge_text" <?php if (isset($single_sale_flash_text)) {
																	echo 'value="' . $single_sale_flash_text . '"';
																} ?>>
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="variable_default_option" <?php if (isset($default_option_variations)) {
																			echo 'value="' . $default_option_variations . '"';
																		} ?>>
		...
		<div class="wsppcp-label-box">
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="text" name="related_pro_title" <?php if (isset($related_product_title)) {
																	echo 'value="' . $related_product_title . '"';
																} ?>>
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="number" name="related_per_page" min="0" max="4" <?php if (isset($related_product_per_page)) {
																						echo 'value="' . $related_product_per_page . '"';
																					} ?>>
			...
			<div class="wsppcp-box-desc">
				...
				<div class="wsppcp-label-content">
					<input type="number" name="related_pro_columns" min="1" <?php if (isset($related_product_column)) {
																				echo 'value="' . $related_product_column . '"';
																			} ?>>
