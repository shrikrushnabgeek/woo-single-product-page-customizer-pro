...
*Set Content in single product pages by Product tag.
...
== Changelog ==
= 2.1.1 =
  - Added support for WooCommerce Product Tags
  - Exclude Tags for Specific Hook
...
= 1.6 =
 Added Option 
 - Exclude Products for Specific Hook
 - Exlucde Categories for Specific Hook

= 1.5 =
 Tested update wp version 6.2.2
...
= 1.2 =
 Set content in product by category
